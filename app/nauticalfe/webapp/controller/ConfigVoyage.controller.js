  ...
  function (BaseController, ODataModel, Context, MessageBox, ODataContextBinding, MessageToast,History) {
    ...
    return BaseController.extend("nauticalfe.controller.ConfigVoyage", {
      ...
      newEntries: function () {
        ...
        var value1 =  this.getView().byId("rels").getValue();
        var value2 =  this.getView().byId("voyType").getValue();
        var value3 =  this.getView().byId("vesType").getValue();
        var value4 =  this.getView().byId("userIdGrp").getValue();
        ...
        let EndPoint = "/odata/v4/nautical/ZVOY_REL";
        fetch(EndPoint, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          ...
          .then(function (res,error) {
            ...
            if (res.ok) {
              ...
              console.log(/odata/v4/nautical/ZVOY_REL)
